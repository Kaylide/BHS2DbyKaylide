...
public class SetupMatchWC : MonoBehaviour
{
    ...
    {
        if (PlayerPrefs.GetInt("isSelectTeamWC") == 0)
        {
            int[] _ValueTopRandom = { 15, 18, 21, 16, 10, 22, 23, 8, 2, 7, 13, 17, 19, 20, 30, 32 };
            int rd = Random.Range(0, 16);
            PlayerPrefs.SetInt("wcPlayer", _ValueTopRandom[rd]);
            WCController.instance.InstanceValueTeam();
            PlayerPrefs.SetInt("isSelectTeamWC", 1);
            WCController.instance.LoadColorTeamPlayer();

        }
        int[] ValueTop1 = { 1, 3, 4, 9, 11, 12, 25, 27 };
        int[] ValueTop2 = { 6, 31, 5, 24, 28, 14, 26, 29 };
        int[] ValueTop3 = { 15, 18, 21, 16, 10, 22, 23, 8 };
        int[] ValueTop4 = { 2, 7, 13, 17, 19, 20, 30, 32 };
